...
LOAD DATA INFILE 'A:/Uni-Nantes/BDD evoluee/Projet/export.csv'
...
INSERT INTO `project_db`.`population_no_moco` 
...
INSERT INTO `project_db`.`small_facts_table` 
	SELECT pop.CODGEO AS code_commune, ngi.numero_departement AS code_dpt, ngi.code_region AS code_region,
		TIMESTAMPDIFF(YEAR, d.date_naissance, d.date_deces) AS id_age, 
	    COUNT(*) AS nb_deaths,
	    pop.SEXE AS sexe,
...
INSERT INTO `project_db`.`facts_table` 
	SELECT pop.CODGEO AS code_commune, ngi.numero_departement AS code_dpt, ngi.code_region AS code_region,
		TIMESTAMPDIFF(YEAR, d.date_naissance, d.date_deces) AS id_age, 
	    COUNT(*) AS nb_deaths,
	    pop.SEXE AS sexe,
