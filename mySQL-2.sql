UPDATE `project_db`.`name_geographic_information` SET `code_insee` = CONCAT("0", code_insee) WHERE CHAR_LENGTH(code_insee) = 4;
...
UPDATE `age` SET `age80_17`= 80 WHERE age80_17 > 80;
